...
// Example usage
const rawData = `ï»¿Title: Note Taker Test Call
Location: google
...
Agenda: 30-Minute General Meeting Agenda
Opening and Welcome (1 minute)
Quick welcome and introduction to the meeting's objectives.
Review of Action Items (3 minutes)
Brief update on the status of action items from the previous meeting.
Key Discussions (20 minutes)
Focused discussion on one or two key issues that need input or decision-making.
Time-bound to ensure brevity and relevance.
Next Steps (3 minutes)
Quick summary of action items arising from the meeting's discussions.
Assigning of responsibilities for these items.
Wrap-Up (3 minutes)
Final thoughts or comments.
Confirm the time for the next meeting.
Meeting Summary
...
const filteredData = filterMeetingData(rawData);
